...
public class OrderCalls {
    ...
    public String Get() throws IOException, InterruptedException{
        HttpResponse<String> response = client.send(HttpRequest.newBuilder(URI.create("https://localhost:7059/api/Order"))
                        .GET().build()
    ...
    public String GetByID(String ID) throws IOException, InterruptedException{
        HttpResponse<String> response = client.send(HttpRequest.newBuilder(URI.create("https://localhost:7059/api/Order/" + ID))
                        .GET().build()
                ,HttpResponse.BodyHandlers.ofString());
        return response.body();
    }
    ...
    public String Post(String value) throws IOException, InterruptedException{
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .uri(URI.create("https://localhost:7059/api/Order"))
    ...
    public String Delete(int ID) throws IOException, InterruptedException{
        HttpResponse<String> response = client.send(
                HttpRequest.newBuilder(URI.create("https://localhost:7059/api/Order/" + ID))
                        .DELETE().build()
                ,HttpResponse.BodyHandlers.ofString());
        return response.body();
    }
